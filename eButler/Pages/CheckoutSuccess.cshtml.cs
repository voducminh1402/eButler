...
namespace eButler.Pages
{
    public class CheckoutSuccessModel : PageModel
    {
        ...
        public async Task OnGetAsync(string token, string PayerID) 
        {
            //string url = "https://www.sandbox.paypal.com//v2/payments/authorizations/" + token + "/capture";
            //        var url = HttpContext.Session.GetString("url");
                   //var authen = HttpContext.Session.GetString("authen");
            ...
            //        // List data response.
            //        var response = await client.GetAsync(url);  // Blocking call! Program will wait here until a response is received or a timeout occurs.
            ...
            //httpRequestMessage.RequestUri = new Uri(url);
            //httpRequestMessage.Headers.Add("Authorization", authen);
